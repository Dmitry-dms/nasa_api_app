...
class EpicViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
    ...
    private fun showEpicData(epic: Epic) {
        this.epic = epic
        val hdUrl =
            "https://epic.gsfc.nasa.gov/archive/natural/${epic.year}/${epic.month}/${epic.day}/png/${epic.image}.png"
        val halfResolutionUrl =
            "https://epic.gsfc.nasa.gov/archive/natural/${epic.year}/${epic.month}/${epic.day}/jpg/${epic.image}.jpg"
        val thumbsUrl =
            "https://epic.gsfc.nasa.gov/archive/natural/${epic.year}/${epic.month}/${epic.day}/thumbs/${epic.image}.jpg"
